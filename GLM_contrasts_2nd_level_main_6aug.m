...
durationsAll = [0];
FFXfolderNames = {...
    'FFX_Rutledge_minEV_6aug2018_ISIfinal_Ch2',... % CR paramMod = CR; durations = 0; with decisions;
...
%             fid = fopen( reportFile, 'a' );
        ...
        if ~exist( FFXdirName, 'dir' ); mkdir(FFXdirName); end 
%         fprintf(fid, 'Erstelle Ordner %s/r/n', FFXdirName );
%         fprintf('FFX dir name: %s\n',FFXdirName)
        ...
        for ses = 1:Nses
            ...
            ISIs(ses) = ISI;
            [onsets,durations,trial_type_names,param_mods,missingOnsets(person_i,ses,:)] = Rutledge_trialtypes_noCompReg_6aug2018_Ch2(fname,ISI);
...
%                              if isempty(sessionData{ses,6}{rrr})
%                                  sessionData{ses,6}{rrr}=[0];
...
%                          end
    ...
    subjectsfolder='/Volumes/SSD/FFX_Rutledge_minEV_6aug2018_ISIfinal/Subjects'; %WARNING: remeber to remove the "/" at the end
    maxmatfolder='/Volumes/SSD/FFX_Rutledge_minEV_6aug2018_ISIfinal/Subjects/SODEC_FMRI_70';
    secondlevelfolder='/Volumes/SSD/FFX_Rutledge_minEV_6aug2018_ISIfinal/Second Level';
    scriptsfolder='/Volumes/SSD/FFX_Rutledge_minEV_6aug2018_ISIfinal/Scripts';
