...
durationsAll = [0];
FFXfolderNames = {...
  'FFX_Rutledge_minEV_1aug2018_ISIfinal_Ch2'};
printCons = 0;
...
% Subjects to do:
 persons{1} = [ 44 62 63 65 69 70 71 74 77 79 81 83 84 90 92 93 94 95 96 98 101 102 103 104 106 110 120 124 125 126 129 136 155 166 171 173 174 175 176 177 ];
          ...
          for ses = 1:Nses
            ...
            ISIs(ses) = ISI;
            [onsets,durations,trial_type_names,param_mods,missingOnsets(person_i,ses,:)] = Rutledge_trialtypes_noCompReg_31july2018_Ch2(fname,ISI);
...
subjectsfolder='/Volumes/SSD/FFX_Rutledge_minEV_31july2018_ISIfinal/Subjects'; %WARNING: remeber to remove the "/" at the end
maxmatfolder='/Volumes/SSD/FFX_Rutledge_minEV_31july2018_ISIfinal/Subjects/SODEC_FMRI_70';
secondlevelfolder='/Volumes/SSD/FFX_Rutledge_minEV_31july2018_ISIfinal/Second Level';
scriptsfolder='/Volumes/SSD/FFX_Rutledge_minEV_31july2018_ISIfinal/Scripts';
