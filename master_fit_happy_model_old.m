...
for whatToDo = toDoList % 1 = fit the data, 2 = create fMRI regressors.
    ...
    for n=1:length(alldata), % n subjects
        ...
        for m=1:length(alldata(n).socdata), % m runs?
            ...
            evmtx=x; certainmtx=x; rpemtx=x; rewardmtx=x; othercertainmtx=x; otherrewardmtx=x; ipemtx=x; envymtx=x; guiltmtx=x; notenvymtx=x; notguiltmtx=x; youchosemtx=x; theychosemtx=x;
