...
durationsAll = [0];
FFXfolderNames = {...
  'FFX_Rutledge_minEV_1aug2018_ISIfinal_Ch2',... % CR paramMod = CR; durations = 0; with decisions; 
...
% Subjects to do:
 persons{1} = [ 44 62 63 65 69 70 71 74 77 79 81 83 84 90 92 93 94 95 96 98 101 102 103 104 106 110 120 124 125 126 129 136 155 166 171 173 174 175 176 177 ]; % all participants
